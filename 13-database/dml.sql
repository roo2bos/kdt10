...
select birth from customer where customer='강해린';
-- 고객 이름이 강해린인 아닌 고객의 생일 검색
select * from customer where customer!='강해린';
